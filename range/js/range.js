...
/*horizontal
-------------------------------------------------------------*/
function RangeH(Bar,Range,Min,Max,minNum,maxNum,Left,Top){
	var num = minNum;
	var range = maxNum - minNum;
	var barLeft = Left;
	var barTop = Top;
	
	var barWidth = 190; //バーの横幅
	var barHeight = 10; //バーの縦幅
...
/*vertical
-------------------------------------------------------------*/
function RangeV(Bar,Range,Min,Max,minNum,maxNum,Left,Top){
	var num = minNum;
	var range = maxNum - minNum;
	var barLeft = Left;
	var barTop = Top;
	
	var barWidth = 10; //バーの横幅
	var barHeight = 190; //バーの縦幅
...
/*horizontal in
-------------------------------------------------------------*/
function RangeHI(Bar,Range,Min,Max,In,minNum,maxNum,Left,Top){
	var num = minNum;
	var range = maxNum - minNum;
	var barLeft = Left;
	var barTop = Top;
